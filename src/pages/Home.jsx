...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="py-20 bg-ivory">
        <div className="container mx-auto px-6">
          <div className="bg-charcoal text-ivory rounded-lg shadow-2xl p-10 md:p-20 text-center" data-aos="fade-up">
            <h2 className="font-display text-4xl md:text-5xl font-bold mb-6">Begin Your Legacy</h2>
            <p className="text-lg text-ivory/80 max-w-2xl mx-auto mb-10">
              Whether you are looking to acquire the exceptional or sell the extraordinary, our team is ready to guide you.
            </p>
            <Link to="/contact" className="bg-soft-gold text-charcoal px-10 py-4 rounded-md text-lg font-semibold hover:bg-dark-gold shadow-lg transition-all duration-300 transform hover:-translate-y-0.5">
